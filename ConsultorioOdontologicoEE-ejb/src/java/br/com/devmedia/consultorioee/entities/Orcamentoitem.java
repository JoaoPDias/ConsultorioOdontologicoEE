...
public class Orcamentoitem implements Serializable {
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "ori_item", nullable = false)
    private int oriItem;
    ...
    public Orcamentoitem(Integer oriId, int oriItem, BigDecimal oriCost) {
        this.oriId = oriId;
    ...
    public int getOriItem() {
        return oriItem;
    }

    public void setOriItem(int oriItem) {
        this.oriItem = oriItem;
    }
